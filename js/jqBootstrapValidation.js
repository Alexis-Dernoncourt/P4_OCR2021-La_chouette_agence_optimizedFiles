      ...
      ajax: {
		...
		builtInValidators: {
			...
			validemail: {
				...
				message: "Entrez une adresse email valide<!-- data-validator-validemail-message to override -->"
			},
			passwordagain: {
				name: "Passwordagain",
				type: "match",
				match: "password",
				message: "Les mots de passe ne correspondent pas, réessayez<!-- data-validator-paswordagain-message to override -->"
			},
			positive: {
				name: "Positive",
				type: "shortcut",
			...
			integer: {
				...
				type: "regex",
				regex: "[+-]?\\\d+",
				message: "Doit être un entier (que les chiffres avant la virgule)<!-- data-validator-integer-message to override -->"
			},
			positivenumber: {
				name: "Positivenumber",
				type: "min",
